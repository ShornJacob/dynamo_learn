...
function increaseRating() {
    ...
    var params = {
        ...
        // UpdateExpression: "set aNum =  :val",
        //UpdateExpression: "set aNum = aNum + :val",
    ...
    docClient.update(params, function(err, data) {
        if (err) {
            ...
            console.log("Increase Rating succeeded: " + JSON.stringify(data, undefined, 2))
        }
    })

}

export default function MoviesItemOps04() {
